  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="group cursor-pointer overflow-hidden bg-gray-900 aspect-[4/3] relative rounded-3xl">
              ...
              {/* Image Placeholder */}
              <img src="https://res.cloudinary.com/dqrofv2dd/image/upload/v1778846019/cld-sample-5.jpg" alt="" />
